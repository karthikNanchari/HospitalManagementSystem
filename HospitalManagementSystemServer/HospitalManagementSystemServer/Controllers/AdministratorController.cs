...
namespace HospitalManagementSystemServer.Controllers
{
    ...
    public class AdministratorController : ApiController
    {
        ...
        [HttpPost, Route("api/Administrator/GetAllNotificationsByRole")]
        public IEnumerable<NotificationsBO> GetAllNotificationsByRole(NotificationsBO manageNotifications)
        {
            AdministratorBLLFactory adminBLLFactory = new AdministratorBLLFactory();
            return adminBLLFactory.CreateAdministratorBLL().ManageNotificationsBLL().ManageNotificationDAL().GetAllNotificationsByRole_DAL(manageNotifications);
        }
        ...
        [HttpPost, Route("api/Administrator/AddAccountDetail")]
        public AccountBO AddAccountDetail(AccountBO accountBO)
        {
            AdministratorBLLFactory adminBLLFactory = new AdministratorBLLFactory();
            return adminBLLFactory.CreateAdministratorBLL().ManageAccountsBLL().CreateAccountDAL().InsertAccountDetails_DAL(accountBO);
        }
