...
namespace HospitalManagementSystemServer.Controllers
{
    public class NurseController : ApiController
    {
        ...
        [HttpPost, Route("api/Nurse/UpdateNurse")]
        ...
        [HttpGet, Route("api/Nurse/GetAllNurses")]
        public IEnumerable<NurseBO> GetAllNurses()
        {
            NurseBLLFactory nurseBLLFactory = new NurseBLLFactory();

            return nurseBLLFactory.CreateNurseBLL().UpdateNurseDetailsBLL().CreateNurseDAL().GetAllNurses_DAL();
        }
