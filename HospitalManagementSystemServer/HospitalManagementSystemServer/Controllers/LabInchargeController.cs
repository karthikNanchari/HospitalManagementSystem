...
namespace HospitalManagementSystemServer.Controllers
{
    public class LabInchargeController : ApiController
    {
        ...
        [HttpGet, Route("api/LabIncharge/GetAllLabInchargeDetials")]
        public IEnumerable<LabInchargeBO> GetAllLabInchargeDetials()
        {
            LabInchargeBLLFactory inchargeBLLFactory = new LabInchargeBLLFactory();

           return inchargeBLLFactory.CreateLabInchargeBLL().UpdateLabInchargeBLL().CreateLabInchargeDAL().GetAllLabInchargeDetials_DAL();
        }

        [HttpPost, Route("api/LabIncharge/UpdateLabIncharge")]
        ...
        //view by InchargeID
        [HttpPost, Route("api/LabIncharge/ViewPatientReports")]
        ...
        [HttpPost, Route("api/LabIncharge/DeletePatientReport")]
        ...
        [ HttpPost, Route("api/LabIncharge/ReqReport")]
        public IEnumerable<ReportBO> ReqReport(AppointmentBO app)
        {
            ReportBLLFactory rprtBLLFactory = new ReportBLLFactory();
            return rprtBLLFactory.CreateReportBLL().DeleteReportBLL().CreateReportDAL().ReqReport(app.appointment_ID);
        }


        [HttpPost, Route("api/LabIncharge/ReqNewReport")]
        public IEnumerable<ReportBO> ReqNewReport(AppointmentBO app)
        {
            ReportBLLFactory rprtBLLFactory = new ReportBLLFactory();
            return rprtBLLFactory.CreateReportBLL().DeleteReportBLL().CreateReportDAL().ReqNewReport(app);
        }
